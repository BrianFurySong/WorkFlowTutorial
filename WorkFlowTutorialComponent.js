(function () {
    ...
    angular.module(AppName).component("workflowTutorialModalPage", {
        ...
        controller: function (requestService, $scope, $window, $filter, $uibModal, $anchorScroll, $location) { //put BLING in front of the injected params EXCEPT for requestService
            var vm = this;
            vm.tutorialBtn = {};
            vm.roles = [];
            vm.$onInit = _init; 

            function _init() {//set these vms in the init so u can use these for either edit and post
